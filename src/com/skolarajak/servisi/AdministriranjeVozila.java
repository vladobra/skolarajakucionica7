...
public class AdministriranjeVozila {
    ...
    public List<Vozilo> generisi() {
    	...
    	System.out.println("Godina proizvodnje poslednjeg registrovanog: " + zadnjeVozilo.getRegistarskiBroj() + " : " + voziloDAO.read(zadnjeVozilo.getRegistarskiBroj()).isAktivno());
